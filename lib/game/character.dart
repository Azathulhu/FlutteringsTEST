...
class Character {
  ...
  final double jumpStrength; // from Supabase
  final double horizontalSpeedMultiplier; // from Supabase
  ...
  Character({
    ...
    required this.horizontalSpeedMultiplier, // ensure Supabase value is used
  ...
  void moveHorizontally(double tiltX, double dt, double screenWidth) {
    // Use Supabase speed multiplier directly
  ...
  void jump() {
    vy = -jumpStrength; // Supabase jump strength
  }
